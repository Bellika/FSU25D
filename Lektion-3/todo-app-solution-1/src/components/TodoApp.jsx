        ...
        <ul>
            {
                todos.map((item, index) => {
                    if (index % 2 === 1) {
                        return <Todo className="" key={item.id} item={item} handleClick={handleClick} deleteTodo={deleteTodo} />
                    } else {
                        return <Todo className="odd" key={item.id} item={item} handleClick={handleClick} deleteTodo={deleteTodo}/>
                    }
                })
            }
        </ul>
